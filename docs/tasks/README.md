...
| — | [TASK-031](TASK-031-round-up-monthly-equivalent.md) Round monthly equivalent up to the nearest öre (FR-37) | TASK-019 | todo | FR-37's `monthly_equivalent` was an unrounded float; this task rounds it up (ceiling, not half-to-even) to two decimal places so a set of summed monthly equivalents never understates the true yearly cost divided by 12 |
...
graph LR
    ...
    T011 --> T029
    T027 --> T029
    T019 --> T031[TASK-031<br/>round monthly equivalent]
    T028 --> T032[TASK-032<br/>household spend confidence threshold]
    T003 --> T032
