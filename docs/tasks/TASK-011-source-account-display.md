...
- [ ] Scenario: Resolve source account when all transactions have the same source
...
- [ ] Scenario: Resolve source account when transactions vary
...
- [ ] Scenario: CLI display shows source account name for single-source pattern
...
- [ ] Scenario: CLI display shows varies indicator for multi-source pattern
...
- [ ] Scenario: CLI display omits source account when not resolved
...
- [ ] Scenario: CSV export includes source account name and varies fields
...
- [ ] Scenario: JSON export includes source account name and varies fields
      Given a set of recurring patterns with varying `source_account_name` and `source_account_varies` values
...
- [ ] Scenario: Export completion prints file path (test coverage for FR-31)
